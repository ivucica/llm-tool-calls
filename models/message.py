...
class Message(pydantic.BaseModel):
    ...
    content: typing.Optional[typing.Union[str, list[MultimodalContent]]] = pydantic.Field(None, description="The content of the message (may be omitted if only tool calls are requested)", skip_defaults=True)
